                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($services as $service)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('services.edit', $service) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900">Editar</a>
                                        <form action="{{ route('services.destroy', $service) }}" method="POST" class="inline-block ml-4" onsubmit="return confirm('¿Seguro?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-4 whitespace-nowrap text-center">No se encontraron servicios.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
